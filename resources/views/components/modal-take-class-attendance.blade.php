...
>
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4 md:p-8">
        <div class="bg-slate-50 w-full max-w-7xl rounded-[3rem] shadow-2xl overflow-hidden border border-white relative">
            ...
            <div class="p-8 md:p-12 max-h-[90vh] overflow-y-auto">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <tr class="hover:bg-slate-50/50 transition" x-data="{ status: 'present' }">
                                <td class="p-6">
                                    <div class="flex items-center gap-4">
                                        <div class="w-12 h-12 bg-slate-100 rounded-2xl flex items-center justify-center font-black text-slate-500">JD</div>
                                        <div>
                                ...
                                <td class="p-6 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button @click="status = 'excused'" :class="status === 'excused' ? 'bg-amber-500 text-white shadow-lg shadow-amber-200' : 'bg-gray-50 text-gray-400 hover:bg-gray-100'" class="px-5 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all">Excused</button>
                                    </div>
                                </td>
                                <td class="p-6">
                                    <input type="text" placeholder="Add reason..." :disabled="status !== 'excused'" :class="status === 'excused' ? 'bg-amber-50 border-amber-200 text-amber-900' : 'bg-gray-50 border-gray-100 text-gray-400 cursor-not-allowed'" class="w-full px-4 py-3 border-2 rounded-xl text-sm font-bold transition-all outline-none focus:border-blue-500">
                                </td>
                            </tr>
                        </tbody>
                    </table>
