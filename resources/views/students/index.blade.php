    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end gap-4">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                ...
                <button @click="$dispatch('open-register-modal', {id: classId})" class="flex-1 md:flex-none bg-blue-600 text-white font-black py-4 px-8 rounded-2xl shadow-lg hover:-translate-y-1 transition-all flex items-center justify-center gap-2 cursor-pointer">
                    Add Student
                </button>
            </div>
        </div>
                        ...
                        <tr class="hover:bg-blue-50/50 transition-colors group">
                            ...
                            <td class="px-8 py-5 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    {{-- Actions using $dispatch to keep modals clean --}}
